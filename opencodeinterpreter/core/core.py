...
class OpenCodeInterpreter:
    ...
    def _streaming_chat(self, message=None, display=True):
        ...
        print(f"core.py display: {display}")
        if display:
            print(f"core.py terminal_interface(self, message)")
        ...
        if message or message == "":
            ...
            print(f"core.py go to self._respond_and_store() start")
            yield from self._respond_and_store()
            print(f"core.py go to self._respond_and_store() complete")
    ...
    def _respond_and_store(self):
        ...
        for chunk in respond(self):
            print(f"core.py respond(self) => chunk: {chunk}")
            if chunk["content"] == "":
                continue
