...
def convert_to_coding_llm(text_llm, debug_mode=False):
    ...
    def coding_llm(messages):
        ...
        messages[0][
            "message"
        ] += "\nTo execute code on the user's machine, write a markdown code block. Specify the language after the ```. You will receive the output. Use python programming language."
