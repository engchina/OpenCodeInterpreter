...
from opencodeinterpreter.terminal_interface.utils.count_tokens import (
...
def test_files():
    messages = [
        {"role": "user", "type": "message", "content": "Does this file exist?"},
        {
            ...
            "type": "file",
            "format": "path",
            "content": "/mnt/data/analytic_ai2.csv",
        },
    ]
...
def test_multiple_instances():
    ...
    agent_1 = interpreter.OpenCodeInterpreter()
    agent_1.system_message = "<3"
    agent_2 = interpreter.OpenCodeInterpreter()
...
def test_math():
    ...
    Perform the calculation `{n1} + {n2} * ({n1} - {n2}) / ({n2} + {n1})` then reply with just the answer, nothing else. No confirmation. No explanation. No words. Do not use commas. Do not show your work. Just return the result of the calculation. Do not introduce the results with a phrase like \"The result of the calculation is...\" or \"The answer is...\"
...
def test_calculation():
    ...
    result = round(n1 + n2 * (n1 - n2) / (n2 + n1), 2)
