...
from st_components.data.database import create_tables, get_all_conversations, get_chats_by_conversation_id, save_conversation, \
    delete_conversation
    ...
    if len(conversation_options) > 0:
        ...
        selected_conversation = option_menu(
            ...
            styles={
                ...
                "nav-link": {"font-family": "Source Sans Pro, sans-serif", "font-size": "12px", "text-align": "left",
                             "margin": "0px", "--hover-color": "#151515", "color": "#FEFEFE"},
